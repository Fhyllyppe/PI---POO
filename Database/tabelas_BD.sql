...
CREATE TABLE Clientes (
    ClienteID SERIAL PRIMARY KEY, NOT NULL AUTO_INCREMENT,
...
CREATE TABLE Cidades (
    CidadeID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
...
CREATE TABLE Estados (
    EstadoID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Nome VARCHAR(100),NOT NULL,
    UF CHAR(2), NOT NULL,
);
-- -----------------------------------------------------
...
-- -----------------------------------------------------
CREATE TABLE Cargos (
    CargoID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Nome VARCHAR(100),NOT NULL,
    SalarioBase MONEY,
...
CREATE TABLE Funcionarios (
    FuncionarioID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Nome VARCHAR(100),NOT NULL,
    CPF VARCHAR(20),
    RG VARCHAR(15),
    DataNascimento DATE,
...
CREATE TABLE FuncionarioPermissao (
    FuncionarioPermissaoID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
...
CREATE TABLE TiposCobrancasRecebimentos (
    TipoCobrancaRecebimentoID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Nome VARCHAR(100),NOT NULL,
    Situacao INTEGER,NOT NULL
);
-- -----------------------------------------------------
...
CREATE TABLE Permissao (
    PermissaoID INTEGER PRIMARY KEY,NOT NULL AUTO_INCREMENT,
...
CREATE TABLE ContasReceber (
    ContaReceberID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
...
CREATE TABLE TiposCobrancasExtras (
    TipoCobrancaExtraID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Nome VARCHAR(100),NOT NULL,
...
CREATE TABLE LocacoesDevolucoes (
    LocacaoDevolucaoID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    ClienteID INTEGER,NOT NULL,
...
CREATE TABLE Adicionais (
    AdicionalID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
...
CREATE TABLE ItensCheckinLocacaoDevolucao (
    LocacaoDevolucaoCheckinID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
...
CREATE TABLE PlanosContas (
    PlanoContaID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Nome VARCHAR(100),NOT NULL,
    Codigo VARCHAR(20),
...
CREATE TABLE ContasPagar (
    ContaPagarID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Valor MONEY,NOT NULL,
    DataVencimento DATE,NOT NULL,
    Desconto MONEY,
    Juros MONEY,
...
CREATE TABLE Fornecedores (
    FornecedorID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
...
CREATE TABLE TiposFornecedores (
    TipoFornecedorID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Nome VARCHAR(100),NOT NULL,
    Situacao INTEGER,NOT NULL
);
-- -----------------------------------------------------
...
-- -----------------------------------------------------
CREATE TABLE Log (
    LogID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
...
CREATE TABLE Seguros (
    SeguroID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT
    Nome VARCHAR(100),NOT NULL,
    Valor MONEY,NOT NULL,
    Descricao VARCHAR(255),
    FornecedorID INTEGER,NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE Grupos (
    GrupoID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Nome VARCHAR(100),NOT NULL,
...
CREATE TABLE Veiculos (
    VeiculoID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
...
CREATE TABLE ItensCheckin (
    ItemCheckinID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Nome VARCHAR(100),NOT NULL,
    Situacao INTEGER,NOT NULL
);
-- -----------------------------------------------------
...
CREATE TABLE TiposAdicionais (
    TipoAdicionalID SERIAL PRIMARY KEY,NOT NULL AUTO_INCREMENT,
    Nome VARCHAR(100),NOT NULL,
    Descricao VARCHAR(255),
    Valor MONEY,NOT NULL,
    Situacao INTEGER,NOT NULL
